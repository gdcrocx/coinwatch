...
export class BTCXIndiaService {
  ...
  constructor(http: Http) {
    this.http = http;
    this.baseUrl = 'https://m.btcxindia.com/api';
    this.urls = {
      getXRPINRCurrentPrice: "/ticker"
    }
  }
  ...
  getXRPINRCurrentPrice() {
    var serviceUrl = this.baseUrl + this.format(this.urls.getXRPINRCurrentPrice);
